...
import { schemeReportTemplateService, type ReportTemplate } from "@/services/scheme-report-template-service"
...
export default function SchemeReportsPage() {
  ...
  const [currencyFormat, setCurrencyFormat] = useState<"rupees" | "lakhs" | "crores">("rupees")
  ...
  const loadTemplates = async () => {
    const templateList = await schemeReportTemplateService.getTemplates()
  ...
  const handleSaveTemplateAndGenerate = async () => {
    ...
    const template: Omit<ReportTemplate, "id" | "createdAt"> = {
      name: templateName,
      reportType: filterSets[0].reportType, // Use first filter's report type
    ...
    await schemeReportTemplateService.saveTemplate(template)
    await loadTemplates()
  ...
  const generateReport = async () => {
    ...
    try {
      const result = await reportService.generateSchemeReport(filters)
  ...
  const handleDeleteTemplate = async (templateId: string) => {
    if (confirm("Are you sure you want to delete this template?")) {
      await schemeReportTemplateService.deleteTemplate(templateId)
      await loadTemplates()
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#013A65] to-[#013A65]/90 rounded-lg py-3 px-6 text-white shadow-lg">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-xl font-semibold">Scheme Reports</h1>
                <p className="text-white/80 text-sm mt-1">
                  Generate scheme-specific reports with template management and advanced filtering
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="space-y-2 md:col-span-2 lg:col-span-3">
                      ...
                      <div className="flex gap-4 items-center">
                        <div className="flex gap-6 h-11 items-center px-3 bg-white rounded-md border border-[#EDEEF0] flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          <label className="text-sm font-medium text-[#013A65] whitespace-nowrap">Amount in:</label>
                          <Select
                            value={currencyFormat}
                            onValueChange={(value) => setCurrencyFormat(value as "rupees" | "lakhs" | "crores")}
                          >
                            <SelectTrigger className="h-11 w-[140px] bg-white border-[#EDEEF0] focus:border-[#013A65] focus:ring-[#013A65]/20">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
              ...
              {/* Container 2: Saved Filters - Right side of Report Filter */}
            ...
            {/* Bottom Section: Table View - Full width */}
            {hasGeneratedReport && (
              <div className="bg-white rounded-lg border border-[#EDEEF0] shadow-sm">
                      ...
                      <Table className="min-w-full">
                        <TableHeader className="sticky top-0 z-10 bg-[#F3B335]">
                          <TableRow className="hover:bg-[#F3B335]">
                            ...
                            <TableHead className="text-[#013A65] font-semibold whitespace-nowrap">Component</TableHead>
                        ...
                        <TableBody>
                          {currentData.map((item) => (
                            <TableRow key={item.id} className="hover:bg-[#F8F8F8]/50">
                              ...
                              <TableCell className="text-right font-mono text-[#013A65] whitespace-nowrap">
