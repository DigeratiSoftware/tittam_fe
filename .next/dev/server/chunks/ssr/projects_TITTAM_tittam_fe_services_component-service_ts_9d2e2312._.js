module.exports = [
"[project]/projects/TITTAM/tittam_fe/services/component-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ComponentService {
    async getAllComponents() {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$TITTAM$2f$tittam_fe$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get("/api/v1/components");
    ...
    async createComponent(request) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$TITTAM$2f$tittam_fe$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post("/api/v1/components", request);
            if (response.success && response.data) {
    ...
    async getComponentById(componentId) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$TITTAM$2f$tittam_fe$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/v1/components/${componentId}`);
            if (response.success && response.data) {
    ...
    async updateComponent(componentId, request) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$TITTAM$2f$tittam_fe$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].put(`/api/v1/components/${componentId}`, request);
            if (response.success && response.data) {
    ...
    async deleteComponent(componentId) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$TITTAM$2f$tittam_fe$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/api/v1/components/${componentId}`);
            if (response.success) {
...
//# sourceMappingURL=projects_TITTAM_tittam_fe_services_component-service_ts_9d2e2312._.js.map